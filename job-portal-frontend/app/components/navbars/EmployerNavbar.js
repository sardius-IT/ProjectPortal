...
export default function EmployerNavbar({ onToggleSidebar }) {
  ...
  return (
    <header className="bg-gray-900 text-white flex items-center justify-between py-4 px-6 fixed top-0 left-0 w-full z-50 shadow-md rounded-2xl">
      {/* Left: Sidebar Toggle + Title */}
      <div className="flex items-center space-x-4 min-w-[150px]">
        <button onClick={onToggleSidebar} className="md:hidden">
          <Menu size={24} />
        </button>
        <h1 className="text-xl font-semibold hidden md:block">Employer panal</h1>
      </div>
